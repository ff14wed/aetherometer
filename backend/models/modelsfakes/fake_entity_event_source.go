...
type FakeEntityEventSource struct {
	SubscribeStub        func() (chan models.EntityEventsPayload, uint64)
	subscribeMutex       sync.RWMutex
	subscribeArgsForCall []struct {
	}
	subscribeReturns struct {
		result1 chan models.EntityEventsPayload
		result2 uint64
	}
...
func (fake *FakeEntityEventSource) Subscribe() (chan models.EntityEventsPayload, uint64) {
...
func (fake *FakeEntityEventSource) SubscribeCalls(stub func() (chan models.EntityEventsPayload, uint64)) {
	fake.subscribeMutex.Lock()
	defer fake.subscribeMutex.Unlock()
	fake.SubscribeStub = stub
}

func (fake *FakeEntityEventSource) SubscribeReturns(result1 chan models.EntityEventsPayload, result2 uint64) {
	fake.subscribeMutex.Lock()
	defer fake.subscribeMutex.Unlock()
...
func (fake *FakeEntityEventSource) SubscribeReturnsOnCall(i int, result1 chan models.EntityEventsPayload, result2 uint64) {
	fake.subscribeMutex.Lock()
	defer fake.subscribeMutex.Unlock()
	fake.SubscribeStub = nil
