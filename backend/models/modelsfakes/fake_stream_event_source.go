...
type FakeStreamEventSource struct {
	SubscribeStub        func() (chan models.StreamEventsPayload, uint64)
	subscribeMutex       sync.RWMutex
	subscribeArgsForCall []struct {
	}
	subscribeReturns struct {
		result1 chan models.StreamEventsPayload
		result2 uint64
	}
...
func (fake *FakeStreamEventSource) Subscribe() (chan models.StreamEventsPayload, uint64) {
...
func (fake *FakeStreamEventSource) SubscribeCalls(stub func() (chan models.StreamEventsPayload, uint64)) {
	fake.subscribeMutex.Lock()
	defer fake.subscribeMutex.Unlock()
	fake.SubscribeStub = stub
}

func (fake *FakeStreamEventSource) SubscribeReturns(result1 chan models.StreamEventsPayload, result2 uint64) {
	fake.subscribeMutex.Lock()
	defer fake.subscribeMutex.Unlock()
...
func (fake *FakeStreamEventSource) SubscribeReturnsOnCall(i int, result1 chan models.StreamEventsPayload, result2 uint64) {
	fake.subscribeMutex.Lock()
	defer fake.subscribeMutex.Unlock()
	fake.SubscribeStub = nil
