...
func init() {
	registerEgressHandler(new(datatypes.MyMovement), newMyMovementUpdate)
}

func newMyMovementUpdate(pid int, b *xivnet.Block, d *datasheet.Collection) store.Update {
	data := b.Data.(*datatypes.MyMovement)
